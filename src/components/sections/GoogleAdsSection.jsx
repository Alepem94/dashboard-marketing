...
import { ChartCard, BarChartComponent } from '../ui/Charts'
    ...
    <div className="space-y-6">
      ...
      {networkComparisonData.length > 0 && (
        <ChartCard title="Comparativa por Red">
          <BarChartComponent data={networkComparisonData} bars={[{ dataKey: 'Clics', color: '#60a5fa' }, { dataKey: 'Inversion', name: 'Inversión', color: '#34d399' }]} height={250} />
        </ChartCard>
      )}
